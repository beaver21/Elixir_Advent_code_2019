defmodule IntCodeTest do
  ...
  test "multiple programme" do
    ...
    assert [30,1,1,4,2,5,6,0,99] == Day2.run(int_codes)
  ...
  test "answer" do
    ...
    assert 5534943 == Enum.at(Day2.run(int_codes), 0)
